...
class User extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('User', package: const $pb.PackageName('bitsflea'), createEmptyInstance: create)
    ...
    ..a<$core.int>(16, 'favoriteTotal', $pb.PbFieldType.O3, protoName: 'favoriteTotal')
    ..a<$core.int>(17, 'collectionTotal', $pb.PbFieldType.O3, protoName: 'collectionTotal')
  ...
  @$pb.TagNumber(16)
  $core.int get favoriteTotal => $_getIZ(15);
  @$pb.TagNumber(16)
  set favoriteTotal($core.int v) { $_setSignedInt32(15, v); }
  @$pb.TagNumber(16)
  $core.bool hasFavoriteTotal() => $_has(15);
  @$pb.TagNumber(16)
  void clearFavoriteTotal() => clearField(16);

  @$pb.TagNumber(17)
  $core.int get collectionTotal => $_getIZ(16);
  @$pb.TagNumber(17)
  set collectionTotal($core.int v) { $_setSignedInt32(16, v); }
  @$pb.TagNumber(17)
  $core.bool hasCollectionTotal() => $_has(16);
  @$pb.TagNumber(17)
  void clearCollectionTotal() => clearField(17);
...
class CollectRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CollectRequest', package: const $pb.PackageName('bitsflea'), createEmptyInstance: create)
    ..a<$core.int>(1, 'user', $pb.PbFieldType.O3)
    ..a<$core.int>(2, 'product', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;

  CollectRequest._() : super();
  factory CollectRequest() => create();
  factory CollectRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CollectRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  CollectRequest clone() => CollectRequest()..mergeFromMessage(this);
  CollectRequest copyWith(void Function(CollectRequest) updates) => super.copyWith((message) => updates(message as CollectRequest));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CollectRequest create() => CollectRequest._();
  CollectRequest createEmptyInstance() => create();
  static $pb.PbList<CollectRequest> createRepeated() => $pb.PbList<CollectRequest>();
  @$core.pragma('dart2js:noInline')
  static CollectRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CollectRequest>(create);
