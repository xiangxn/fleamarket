...
class ExtDialog {
  ...
  static TextStyle get _msgStyle =>
      ...
      res = await showGeneralDialog(
          ...
          pageBuilder: (BuildContext context, Animation<double> animation,
            ...
            final Widget pageChild = Builder(builder: (BuildContext context) {
              if (autoDismissible) {
                Future.delayed(
                    Duration(milliseconds: 2000), () => close(context));
              }
  ...
  static Future<dynamic> _dialog(BuildContext context, String msg, String title,
      [int btnCount = 1]) {
    return _baseDialog(
        context: context,
        content: Column(
          ...
          children: <Widget>[
            Text(title ?? "温馨提示", style: _titleStyle),
            Padding(
            ...
            Row(
                ...
                children: List.generate(btnCount, (inx) => inx).map((i) {
                  ...
                  return FlatButton(
                    ...
                    child: Text(isFirst ? "确定" : "取消",
                        style: TextStyle(
                            color: isFirst ? Colors.green : Colors.grey[800])),
                  );
                }).toList())
          ],
        ));
  ...
  static Future<dynamic> alert(BuildContext context, String msg,
      [String title]) {
    return _dialog(context, msg, title);
  }

  static Future<dynamic> confirm(BuildContext context, String msg,
      [String title]) {
